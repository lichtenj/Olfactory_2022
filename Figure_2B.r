...
newdata<-data[(data$Group!="?/PD" & data$Group!="GD/ND" & data$Group!="WT/FH" & data$Group!="Conv" & data$Group!="GD3/PD" & data$Group!="WT" & data$Group!="GC" & data$Group!="GC/PD" & data$Group!="GC/FH"),]
